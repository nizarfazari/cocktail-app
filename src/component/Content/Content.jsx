...
const Contents = (props) => {
  ...
  return (
    <div className="containers  mx-auto pt-5 ">
      ...
      <div className="title-contents flex justify-between items-center mt-10 mb-4">
      ...
      <div className="kontents grid xl:grid-cols-4 md:grid-cols-3 gap-4 grid-cols-2">
        {props.meals &&
          props.meals.map((meal) => {
            return (
              <div className="cards p-6 rounded-xl text-white cursor-pointer hover:brightness-50 duration-500 delay-150 " onClick={() => navigate(`/${meal.idMeal}`)}>
